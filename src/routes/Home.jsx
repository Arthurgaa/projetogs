        ...
        <div className="w-full min-h-screen flex flex-col bg-white">
            ...
            <div className="flex-grow flex flex-col items-center justify-center mb-16 px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full max-w-6xl">
                    <Link to="/solucao#incentivo-energias-renovaveis" className="bg-[#EFFDF3] shadow-lg rounded-lg p-10 text-center transform transition duration-300 hover:scale-105 hover:shadow-2xl">
                    ...
                    <Link to="/solucao#desenvolvimento-armazenamento" className="bg-[#EFFDF3] shadow-lg rounded-lg p-10 text-center transform transition duration-300 hover:scale-105 hover:shadow-2xl">
                    ...
                    <Link to="/solucao#mobilidade-eletrica" className="bg-[#EFFDF3] shadow-lg rounded-lg p-10 text-center transform transition duration-300 hover:scale-105 hover:shadow-2xl">
